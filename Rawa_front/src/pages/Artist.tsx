        ...
        <div className="md:pl-64 md:pr-64 md:pt-10">
            <div className="flex md:flex-row">
                ...
                <div className="md:pl-10">
                    <h2 className="font-bold md:text-4xl font-moch">{id?.toUpperCase()}</h2>
            ...
            <div className="mt-10">
                <div className="border-b-8 flex md:flex-row items-center justify-around">
                    ...
                    >Feed</h3>
                    <h3 
                    className={isFeed ? "font-moch cursor-pointer font-bold text-4xl" : "font-moch cursor-pointer text-priColor border-b-8 border-priColor font-bold text-4xl"}
                    onClick={()=>setIsFeed(!isFeed)}
                    >Media</h3>
                </div>
